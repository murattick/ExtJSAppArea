...
namespace SmartCom.Controllers
{
    public class ShopController : Controller
    {
        ...
        public JsonResult GetBrands(int? start, int? limit)
        {
            {
                ...
                int cnt = db.Brands.Count();
                //unitOfWork.CategoryRepository.Get().Count();

                //сам запрос на вывод товаров
                var recs = db.Brands.ToList();
                //unitOfWork.CategoryRepository.Get().
